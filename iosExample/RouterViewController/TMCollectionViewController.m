...
@interface TMCollectionViewController ()<UICollectionViewDataSource, UICollectionViewDelegate>
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(reachCellForIndex:)]) {
        [self.delegate reachCellForIndex:indexPath];
    }
    
    if (self.reachCellForIndexCallback) {
        self.reachCellForIndexCallback(indexPath);
    }
